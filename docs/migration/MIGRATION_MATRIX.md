...
| **`kingdom/construction`** | DOMAIN SERVICE | **PENDING / DEFERRED** | B — Minimal Adaptation | Low | Deferred until construction PRNG audit | [KINGDOM_PRODUCTION_MIGRATION_REPORT.md](file:///c:/Projetos/Age_Of_Shattered_Oats/docs/migration/KINGDOM_PRODUCTION_MIGRATION_REPORT.md) |
