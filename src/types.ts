...
export interface CampaignState {
  ...
  // MEM-002/MEM-003: Canonical memory stores (optional for backward compatibility)
  memoryStores?: {
    ...
    // MEM-003: Propagation state
    agentRegistry?: import('./memory/propagation/AgentRegistry').AgentEntry[];
